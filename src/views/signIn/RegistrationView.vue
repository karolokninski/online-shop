<template>
  <div class="bg-white flex min-h-full flex-1 flex-col">
    <header class="absolute bg-white inset-x-0 top-0 z-40 mt-2">
    ...
    <div class="flex flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" method="POST" onsubmit="return false">
          ...
          <div>
            <button type="submit" @click="handleRegistration" class="flex w-full h-9 justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
              ...
              <span v-else class="text-sm font-semibold leading-6 text-white">Zarejestruj się</span>
            </button>
          </div>
        </form>
