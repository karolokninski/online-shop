    ...
    <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
      ...
      <div class="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                ...
                <div class="flex items-center">
                  <div class="">
                    ...
                    <div class="flex items-center ">
                      ...
                      <p class="font-medium text-base leading-7 text-black ">Qty: <span class="text-gray-500">2</span>
                      </p>
                    </div>
                  </div>
                ...
                <div class="flex items-center">
                  <div class="">
                    ...
                    <div class="flex items-center  ">
                      ...
                      <p class="font-medium text-base leading-7 text-black ">Qty: <span class="text-gray-500">1</span>
                      </p>
                    </div>
                  </div>
        ...
        <div class="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
          ...
          <p class="font-semibold text-lg text-black py-6">Total Price: <span class="text-indigo-600"> $200.00</span>
          </p>
        </div>
